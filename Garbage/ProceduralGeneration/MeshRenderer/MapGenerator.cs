...
public class MapGenerator : MonoBehaviour
{
    ...
    public void DrawMapInEditor()
    {
        ...
        {
            display.DrawMesh(MeshGenerator.GenerateTerrainMesh(mapData.heightMap, meshHeightMultiplier, meshHeightCurve, editorPreviewLOD), TextureGenerator.TextureFromeColorMap(mapData.colorMap, mapChunkSize, mapChunkSize));
        }
    }
