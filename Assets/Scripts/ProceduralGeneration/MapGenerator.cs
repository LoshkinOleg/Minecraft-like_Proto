...
public class MapGenerator : MonoBehaviour
{
    ...
    public void DrawMapInEditor()
    {
        ...
        {
            display.DrawMesh(MeshGenerator.GenerateTerrainMesh(mapData.heightMap, meshHeightMultiplier, meshHeightCurve, levelOfDetail), TextureGenerator.TextureFromeColorMap(mapData.colorMap, mapChunkSize, mapChunkSize));
        }
    }
